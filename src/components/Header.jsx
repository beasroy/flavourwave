    ...
    return (
        <div className='w-full h-[100vh]'>
            <div className='relative w-full h-full'>
                <img src={ image ?? images[Math.floor(Math.random()*images.length)]} alt='food banner' className='w-full h-full object-cover'/>
            </div>
            ...
            {
          type && (
            <p className='text-sm mt-4 text-center text-green-500 bg-[#00000090] px-6 py-4 rounded-full '>Welcome to FlavorWave, your passport to culinary adventures!
